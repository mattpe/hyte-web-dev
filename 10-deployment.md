...
1. [Build](./10-deployment.md#publishing-the-website-created-with-vite) your Vite app (`npm run build`) to create the static HTML/CSS/JS/etc. website files. (You cannot use the Vite development server for production on the server.)
